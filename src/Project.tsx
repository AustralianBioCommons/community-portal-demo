...
// extension of Paper class to be a collapsible paper with header
interface collapsiblePaperType extends PaperProps {
    header: React.ReactNode
}

// render portion of CollapsiblePaper
...
// End of paper class extension

// type definitions for the displayed classes and their respective rendering functions
type systemType = {
    id: number,
    name: string
};

export const System = (system: systemType) => <Box>
...
export const Data = (data:dataType) => <TableContainer variant="outlined" sx={{padding: 2, maxWidth: 360}} component={Paper}>
    <Table >
        <TableBody>
            <TableRow >
...
export const User = ( user: userType) => <Box alignItems="center" sx={{position: "relative", display: "inline-flex"}}>
